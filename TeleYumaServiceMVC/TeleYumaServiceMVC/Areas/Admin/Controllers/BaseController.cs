...
namespace TeleYumaServiceMVC.Areas.Admin.Controllers
{
    public class BaseController : Controller
    {
        ...
        //    if ((TipoTienda)Session["TipoTienda"] == TipoTienda.Padre)
        //    {
        //        await ((customer_info)Session["CurrentCustomer"]).MakeTransaction_Manualcharge((float)recarga.Costo, "Movil-" + recarga.Monto + "-" + recarga.CodigoPais + recarga.Numero);

        //    }
        //    else
        //    {
        //        await ((customer_info)Session["CurrentAccont"]).MakeTransaction_Manualcharge((float)recarga.Costo, "Movil-" + recarga.Monto + "-" + recarga.CodigoPais + recarga.Numero);
        //    }
